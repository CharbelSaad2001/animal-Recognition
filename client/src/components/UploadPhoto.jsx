...
import { uploadAndAnalize } from "../services/analize-animal";
...
export function UploadPhoto() {
  ...
  const [file, setFile] = useState(null);
    ...
    const animalData = await uploadAndAnalize(file);
		console.log(animalData);
    if (animalData) {
      navigate("/animal-detail", { state: { image: imageBase64, animalData } });
    }
	};
